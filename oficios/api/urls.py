...
from oficios.api.views import get_oficios, get_departamentos, get_remitentes, get_oficios_by_id, \
    ...
    update_remitente, get_estadistics, get_estadistics_filtro, get_oficios_filtro

urlpatterns = [
    url(r'^get_oficios/$', get_oficios),
    url(r'^get_departamentos/$', get_departamentos),
    url(r'^get_remitentes/$', get_remitentes),
    url(r'^get_oficios_by_id/(?P<oficio_id>\d+)/$', get_oficios_by_id),
    url(r'^get_departamentos_by_id/(?P<departamento_id>\d+)/$', get_departamentos_by_id),
    url(r'^get_remitentes_by_id/(?P<remitente_id>\d+)/$', get_remitentes_by_id),
    ...
    url(r'^get_oficios_filtro/$', get_oficios_filtro),
]
